	...
	public void configureZone(StendhalRPZone zone,
		...
		final SpeakerNPC npc = new SpeakerNPC("Dagobert") {
			...
			public void createDialog() {
				...
				addHelp("Follow the corridor to the right, and you will find the magic chests. You can store your belongings in any of them, and nobody else will be able to touch them! A number of spells have been cast on the chest areas to ensure #safety. We also have #bankstatement feature.");
